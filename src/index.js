...
const loading = document.querySelector(".cases");
const recovered = document.querySelector(".recovered");
const deaths = document.querySelector(".deaths");
const results = document.querySelector(".result-container");
results.getElementsByClassName.display = "none";
...
const searchForCountry = async country => {
    ...
    try {
        ...
        errors.textContent = "We have no data for the coutry you have requested.";
